...
const STAssistantWidget = () => {
    ...
    // ... (你的聯絡方式陣列保持不變)
    {
      ...
      icon: (
        ...
        >
          ...
          {/* 🚀 第二層：綠色對話框線條 (加厚描邊) */}
          <path
            d="M12.04 3.67c4.54 0 8.24 3.7 8.24 8.24 0 4.54-3.7 8.24-8.24 8.24-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.32a8.188 8.188 0 01-1.26-4.37c0-4.54 3.7-8.24 8.25-8.24m0-1.67c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01z"
            fill="#25D366"
            stroke="#25D366"
            strokeWidth="0.8"
          />
          {/* 🚀 第三層：白色電話話筒 (微調加厚，讓話筒形狀更清晰、更結實) */}
          <path
            d="M15.37 13.9c-.21-.1-.1.25-1.42-.41-.2-.1-.35-.05-.48.14-.13.19-.5.63-.62.77-.12.14-.24.15-.45.05-.21-.1-.88-.32-1.68-1.03-.62-.55-1.04-1.23-1.16-1.44-.12-.21-.01-.32.09-.42.09-.09.21-.24.31-.36.1-.12.14-.21.21-.35.07-.14.03-.26-.02-.36-.05-.1-.48-1.16-.66-1.59-.18-.43-.36-.37-.49-.38-.12 0-.26-.01-.4-.01-.14 0-.36.05-.55.26-.19.21-.73.71-.73 1.74 0 1.03.75 2.02.85 2.16.1.14 1.48 2.26 3.59 3.17.5.22.89.35 1.2.45.51.16.97.14 1.33.09.41-.06 1.27-.52 1.45-1.02.18-.5.18-.93.13-1.02-.05-.1-.19-.15-.4-.26z"
            fill="#FFFFFF"
            stroke="#FFFFFF"
            strokeWidth="0.8"
  ...
  return (
    <div className="fixed bottom-6 right-6 lg:right-10 z-[9999] flex flex-col items-end font-sans">
      ...
      {/* 2. 🚀 新增：WhatsApp 經典懸浮客服按鈕 */}
      <a
        href="https://wa.me/60169404939"
        target="_blank"
        rel="noopener noreferrer"
        title="Chat on WhatsApp"
        className="fixed right-1.5 lg:right-1.5 mb-3.5 w-12 h-12 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-95 transition-all duration-300 relative group"
      >
        {/* 剛才精心微調好的 100% 實心 + 粗線條 WhatsApp SVG */}
        <svg
          width="22"
          height="22"
          viewBox="0 0 24 24"
        ...
        {/* 滑鼠移入時左側浮出的提示小文字標籤 (可選) */}
        <span className="absolute right-14 bg-black/80 text-white text-xs px-2.5 py-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap border border-white/10 pointer-events-none">
          WhatsApp 客服
        </span>
      </a>
      {/* 懸浮主按鈕 */}
